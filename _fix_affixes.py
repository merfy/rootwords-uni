...
exec(content.replace('export default DATA;', '').replace('// Auto-generated data file', '# Auto-generated data file'))
...
PREFIX_MEANINGS = {
    ...
    'mono-': '单一，一个', 'multi-': '多',
    'ob-': '反对，朝向', 'palin-': '回，向后', 'pen-': '几乎，接近',
    'per-': '贯穿，彻底', 'phago-': '吃，吞噬',
    'philo-': '爱，喜好', 'poly-': '多', 'pre-': '前，预先',
...
count_no_affix = sum(1 for d in DATA if 'affixes' not in d)
print(f'Entries without affixes: {count_no_affix} / {len(DATA)}')
